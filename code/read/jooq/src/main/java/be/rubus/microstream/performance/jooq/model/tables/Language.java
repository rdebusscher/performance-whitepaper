...
import be.rubus.microstream.performance.jooq.model.tables.records.LanguageRecord;
...
public class Language extends TableImpl<LanguageRecord> {
     ...
     */
    public final TableField<LanguageRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>public.language.languagetag</code>.
     */
    public final TableField<LanguageRecord, String> LANGUAGETAG = createField(DSL.name("languagetag"), SQLDataType.VARCHAR(255), this, "");
