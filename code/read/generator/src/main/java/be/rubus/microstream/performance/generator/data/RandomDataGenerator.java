...
import be.rubus.microstream.performance.generator.config.RandomDataAmount;
import be.rubus.microstream.performance.microstream.database.Books;
import be.rubus.microstream.performance.microstream.database.Customers;
import be.rubus.microstream.performance.microstream.database.Purchases;
import be.rubus.microstream.performance.microstream.database.Shops;
import be.rubus.microstream.performance.microstream.database.model.Purchase;
import be.rubus.microstream.performance.microstream.database.model.PurchaseItem;
